...
const Strings = () => {
  ...
  useEffect(() => {
    ...
    const accessDate = new Date(2025, 0, 20);
...
print(foodForDinosaurus)`}
          ...
          <div className="bg-white rounded-lg p-8 shadow-sm mb-8 animate-fade-up">
            ...
            <p className="text-gray-700 mb-4">
              Если строка слишком длинная, её можно разделить на несколько строк, используя тройные кавычки (''' или """).
            </p>
...
print(food)`}
          ...
          <div className="bg-white rounded-lg p-8 shadow-sm mb-8 animate-fade-up">
            ...
            <p className="text-gray-700 mb-4">
              Python поддерживает специальные символы:
            </p>
            <ul className="list-disc pl-6 text-gray-700 mb-4">
              <li>\n — перенос строки</li>
              <li>\t — табуляция (4 пробела)</li>
            </ul>

            <CodeBlock 
              code={`print("aaa \\n bbb")  # Перенос строки
print("aaa \\t bbb")  # Табуляция`}
            />
          </div>
