        ...
        <section className="prose lg:prose-xl mx-auto">
          <div className="bg-white rounded-lg p-8 shadow-sm mb-8 animate-fade-up">
            ...
            <p className="text-gray-700 mb-4">
              Условные операторы позволяют изменять ход выполнения программы в зависимости от заданных условий. Благодаря этим конструкциям программа может выполнять разные действия в зависимости от заданных условий. Это основа для создания программ с ветвлением логики.
            </p>
            ...
            <p className="text-gray-700 mb-4">
              Оператор if выполняет код, только если условие истинно (True).
            </p>
...
if x > 0:
    print("Число положительное")`}
              description="Если значение переменной x больше 0, то программа выведет: 'Число положительное'. Если условие ложно, то выполнение оператора if будет пропущено."
            />
            ...
            <p className="text-gray-700 mb-4">
              Оператор else используется, чтобы указать действия, которые выполняются, если условие if ложно.
            </p>
